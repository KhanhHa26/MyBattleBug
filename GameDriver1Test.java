...
public class GameDriver1Test
{
    ...
    public static void main(String[] args)
    {
        ...
        battleBugs.add(new BuzzLightyear(0,3,2, "PINK1", Color.PINK));
        battleBugs.add(new BuzzLightyear(2,2,1, "RED2", Color.RED));
        battleBugs.add(new BuzzLightyear(0,4,1, "CYAN3", Color.CYAN));
        battleBugs.add(new BuzzLightyear(0,5,0, "BuzzLightyear", Color.GREEN));
